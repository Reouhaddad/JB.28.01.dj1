...
class ProductSerializer(serializers.ModelSerializer): 
    class Meta:
        model = Product
        fields = '__all__'
    def create(self, validated_data): #verifie quel user est connecter pour lui afficher ces produits
...
def register(request):
    user = User.objects.create_user( # on peut le faire avec create et non pas create user sauf que avec user il hash le password
